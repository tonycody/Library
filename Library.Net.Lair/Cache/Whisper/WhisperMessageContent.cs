...
{
    [DataContract(Name = "WhisperMessageContent", Namespace = "http://Library/Net/Lair")]
    public sealed class WhisperMessageContent : ItemBase<WhisperMessageContent>, IWhisperMessageContent<Key>
    {
        ...
        public WhisperMessageContent(string comment, IEnumerable<Key> anchors)
        {
        ...
        {
            if ((object)obj == null || !(obj is WhisperMessageContent)) return false;

            return this.Equals((WhisperMessageContent)obj);
        }

        public override bool Equals(WhisperMessageContent other)
        {
        ...
        public override WhisperMessageContent DeepClone()
        {
            using (var stream = this.Export(BufferManager.Instance))
            {
                return WhisperMessageContent.Import(stream, BufferManager.Instance);
            }
        }
        ...
        public string Comment
        {
            ...
            private set
            {
                if (value != null && value.Length > WhisperMessageContent.MaxCommentLength)
                {
        ...
        private KeyCollection ProtectedAnchors
        {
            ...
            {
                if (_anchors == null)
                    _anchors = new KeyCollection(WhisperMessageContent.MaxAnchorsCount);
