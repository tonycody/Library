...
{
    [DataContract(Name = "Whisper", Namespace = "http://Library/Net/Lair")]
    public sealed class Whisper : ItemBase<Whisper>, IWhisper
    {
        ...
        public Whisper(byte[] id, string name)
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            if ((object)obj == null || !(obj is Whisper)) return false;

            return this.Equals((Whisper)obj);
        }

        public override bool Equals(Whisper other)
        {
        ...
        public override Whisper DeepClone()
        {
            using (var stream = this.Export(BufferManager.Instance))
            {
                return Whisper.Import(stream, BufferManager.Instance);
            }
        }
        ...
        public byte[] Id
        {
            ...
            private set
            {
                if (value != null && (value.Length > Whisper.MaxIdLength))
                {
        ...
        public string Name
        {
            ...
            private set
            {
                if (value != null && value.Length > Whisper.MaxNameLength)
                {
                    throw new ArgumentException();
                }
                else
