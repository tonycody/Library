...
{
    [DataContract(Name = "TopicHeader", Namespace = "http://Library/Net/Lair")]
    public sealed class TopicHeader : ReadOnlyCertificateItemBase<TopicHeader>, ITopicHeader<Channel, Key>
    {
        ...
        public TopicHeader(Channel channel, Key content, DigitalSignature digitalSignature)
        {
        ...
        {
            if ((object)obj == null || !(obj is TopicHeader)) return false;

            return this.Equals((TopicHeader)obj);
        }

        public override bool Equals(TopicHeader other)
        {
        ...
        public override TopicHeader DeepClone()
        {
            using (var stream = this.Export(BufferManager.Instance))
            {
                return TopicHeader.Import(stream, BufferManager.Instance);
            }
        }
    ...
    public sealed class TopicContent : ItemBase<TopicContent>, ITopicContent
    {
        ...
        public TopicContent(ContentFormatType formatType, string content)
        {
