...
namespace Library.Net.Lair
{
    ...
    public sealed class Mail : ReadOnlyCertificateItemBase<Mail>, IMail<Key>
    {
        ...
        public Mail(string recipientSignature, Key content, DigitalSignature digitalSignature)
        {
