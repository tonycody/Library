...
{
    [DataContract(Name = "SectionProfileHeader", Namespace = "http://Library/Net/Lair")]
    sealed class SectionProfileHeader : ReadOnlyCertificateItemBase<SectionProfileHeader>, ISectionProfileHeader<Section>
    {
        ...
        public SectionProfileHeader(Section tag, DateTime creationTime, Key key, DigitalSignature digitalSignature)
        {
            this.Tag = tag;
        ...
        {
            if ((object)obj == null || !(obj is SectionProfileHeader)) return false;

            return this.Equals((SectionProfileHeader)obj);
        }

        public override bool Equals(SectionProfileHeader other)
        {
        ...
        #region ISectionProfileHeader<Section>
