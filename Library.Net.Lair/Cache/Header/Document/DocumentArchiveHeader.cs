...
{
    [DataContract(Name = "DocumentArchiveHeader", Namespace = "http://Library/Net/Lair")]
    public sealed class DocumentArchiveHeader : ReadOnlyCertificateItemBase<DocumentArchiveHeader>, IDocumentArchiveHeader<Document>
    {
        ...
        public DocumentArchiveHeader(Document tag, Key key, DigitalSignature digitalSignature)
        {
            this.Tag = tag;
        ...
        {
            if ((object)obj == null || !(obj is DocumentArchiveHeader)) return false;

            return this.Equals((DocumentArchiveHeader)obj);
        }

        public override bool Equals(DocumentArchiveHeader other)
        {
        ...
        #region IDocumentArchiveHeader<Document>
