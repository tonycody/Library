...
namespace Library.Net.Lair
{
    ...
    sealed class ChatTopicHeader : ReadOnlyCertificateItemBase<ChatTopicHeader>, IChatTopicHeader<Chat>
    {
        ...
        public ChatTopicHeader(Chat tag, DateTime creationTime, Key key, DigitalSignature digitalSignature)
        {
            this.Tag = tag;
        ...
        {
            if ((object)obj == null || !(obj is ChatTopicHeader)) return false;

            return this.Equals((ChatTopicHeader)obj);
        }

        public override bool Equals(ChatTopicHeader other)
        {
