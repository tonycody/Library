...
{
    [DataContract(Name = "Vote", Namespace = "http://Library/Net/Lair")]
    public sealed class Vote : ReadOnlyCertificateItemBase<Vote>, IVote<Section, Key>
    {
        ...
        public Vote(Section section, Key content, DigitalSignature digitalSignature)
        {
        ...
        {
            if ((object)obj == null || !(obj is Vote)) return false;

            return this.Equals((Vote)obj);
        }
        ...
        public override Vote DeepClone()
        {
            using (var stream = this.Export(BufferManager.Instance))
            {
                return Vote.Import(stream, BufferManager.Instance);
            }
        }
