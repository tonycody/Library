...
namespace Library.Net.Lair
{
    ...
    public sealed class Profile : ReadOnlyCertificateItemBase<Profile>, IProfile<Section, Key>
    {
        ...
        public Profile(Section section, Key content, DigitalSignature digitalSignature)
        {
