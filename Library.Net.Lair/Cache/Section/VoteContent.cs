...
{
    [DataContract(Name = "VoteContent", Namespace = "http://Library/Net/Lair")]
    public sealed class VoteContent : ItemBase<VoteContent>, IVoteContent<Key>
    {
        ...
        public VoteContent(IEnumerable<Key> goods, IEnumerable<Key> bads)
        {
        ...
        {
            if ((object)obj == null || !(obj is VoteContent)) return false;

            return this.Equals((VoteContent)obj);
        }

        public override bool Equals(VoteContent other)
        {
        ...
        public override VoteContent DeepClone()
        {
            using (var stream = this.Export(BufferManager.Instance))
            {
                return VoteContent.Import(stream, BufferManager.Instance);
            }
        }

        #region IVoteContent<Key>
        ...
        private KeyCollection ProtectedGoods
        {
            ...
            {
                if (_goods == null)
                    _goods = new KeyCollection(VoteContent.MaxGoodsCount);
        ...
        private KeyCollection ProtectedBads
        {
            ...
            {
                if (_bads == null)
                    _bads = new KeyCollection(VoteContent.MaxBadsCount);
