...
namespace Library.Net.Lair
{
    ...
    public sealed class ChatTopic : ReadOnlyCertificateItemBase<ChatTopic>, IChatTopic<Chat, Key>
    {
        ...
        public ChatTopic(Chat chat, Key content, DigitalSignature digitalSignature)
        {
            this.Chat = chat;
