...
{
    [DataContract(Name = "DocumentSite", Namespace = "http://Library/Net/Lair")]
    public sealed class DocumentSite : ReadOnlyCertificateItemBase<DocumentSite>, IDocumentSite<Document, Key>
    {
        ...
        public DocumentSite(Document document, Key content, DigitalSignature digitalSignature)
        {
        ...
        {
            if ((object)obj == null || !(obj is DocumentSite)) return false;

            return this.Equals((DocumentSite)obj);
        }

        public override bool Equals(DocumentSite other)
        {
        ...
        public override DocumentSite DeepClone()
        {
            using (var stream = this.Export(BufferManager.Instance))
            {
                return DocumentSite.Import(stream, BufferManager.Instance);
            }
        }
        ...
        #region IDocumentSite<Document, Key>
