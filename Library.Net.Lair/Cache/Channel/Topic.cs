...
namespace Library.Net.Lair
{
    ...
    public sealed class Topic : ReadOnlyCertificateItemBase<Topic>, ITopic<Channel, Key>
    {
        ...
        public Topic(Channel channel, Key content, DigitalSignature digitalSignature)
        {
