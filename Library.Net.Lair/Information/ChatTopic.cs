...
namespace Library.Net.Lair
{
    ...
    public sealed class ChatTopic : IMessage<Chat>, IEquatable<ChatTopic>
    {
        private Chat _tag;
        ...
        public bool Equals(ChatTopic other)
        {
        ...
        public string Hypertext
        {
            ...
            private set
            {
                lock (this.ThisLock)
                {
                    if (value != null && value.Length > ChatTopic.MaxHypertextLength)
                    {
                        throw new ArgumentException();
                    }
                    else
