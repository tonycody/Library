...
namespace Library.Net.Outopos
{
    static class ContentConverter
    {
        ...
        private static Stream Compress(Stream stream)
        {
            ...
            var targetStream = new RangeStream(stream);
            ...
            list.Add(new KeyValuePair<byte, Stream>((byte)ConvertCompressionAlgorithm.None, new WrapperStream(targetStream, true)));
