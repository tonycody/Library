...
namespace Library.Net.Outopos
{
    ...
    public sealed class SectionProfileContent : ItemBase<SectionProfileContent>
    {
        ...
        public SectionProfileContent(ExchangePublicKey exchangePublicKey, IEnumerable<string> trustSignatures, IEnumerable<Wiki> wikis, IEnumerable<Chat> chats)
        {
