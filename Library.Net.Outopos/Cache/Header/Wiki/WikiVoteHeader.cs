...
{
    [DataContract(Name = "WikiVoteHeader", Namespace = "http://Library/Net/Outopos")]
    sealed class WikiVoteHeader : ReadOnlyCertificateItemBase<WikiVoteHeader>, IWikiVoteHeader<Wiki>
    {
        ...
        public WikiVoteHeader(Wiki tag, DateTime creationTime, Key key, DigitalSignature digitalSignature)
        {
            this.Tag = tag;
