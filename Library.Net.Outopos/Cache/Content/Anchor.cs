    ...
    public sealed class Anchor : ItemBase<Anchor>, IAnchor
    {
        ...
        protected override Stream Export(BufferManager bufferManager, int count)
        {
            lock (this.ThisLock)
            {
                ...
                {
                    ItemUtility.Write(bufferStream, (byte)SerializeId.Signature, this.Signature, bufferManager);
                }
                // CreationTime
                if (this.CreationTime != DateTime.MinValue)
                {
                    ItemUtility.Write(bufferStream, (byte)SerializeId.CreationTime, this.CreationTime.ToUniversalTime().ToString("yyyy-MM-ddTHH:mm:ssZ", System.Globalization.DateTimeFormatInfo.InvariantInfo), bufferManager);
                }
