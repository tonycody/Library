...
namespace Library.Net.Connections
{
    static class Crc32_Castagnoli
    {
        ...
        public static byte[] ComputeHash(byte[] buffer, int offset, int length)
        {
            ...
            else if (offset < 0 || buffer.Length < offset) throw new ArgumentOutOfRangeException("offset");
            else if (length < 0 || (buffer.Length - offset) < length) throw new ArgumentOutOfRangeException("length");
